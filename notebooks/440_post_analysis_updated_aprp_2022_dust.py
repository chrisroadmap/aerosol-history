...
ERFari = load_dict_from_hdf5('../data_output/results/dust/ERFari.h5')
ERFaci = load_dict_from_hdf5('../data_output/results/dust/ERFaci.h5')
temp   = load_dict_from_hdf5('../data_output/results/dust/temp.h5')
ks     = load_dict_from_hdf5('../data_output/results/dust/knutti_score.h5')
ohc    = load_dict_from_hdf5('../data_output/results/dust/ohc.h5')
hflux  = load_dict_from_hdf5('../data_output/results/dust/hflux.h5')
pc = load_dict_from_hdf5('../data_output/results/dust/pc.h5')
...
fig.tight_layout()
pl.savefig('../figures/figure6_dust.png', dpi=300)
pl.savefig('../figures/figure6_dust.pdf')
